        ...
        <div class="col-md-4 offset-md-4 form-div login">
            <form action="<?php echo($_SERVER["PHP_SELF"]);?>" method="POST">
                <div class="card-header">
                    <h4 align="center">ADD ZONE
                        <a href="dashbord/zoneDashbord.php" class="btn btn-danger float-end">BACK</a>
                ...
                <div align="left">
                    ...
                    <input type="text" class="form-control" name="code" id="code" style="color:brown" value="<?php echo $zone_code; ?>" readonly>
                </div>
